"""
Django settings for dorm_detective project.
...
ROOT_URLCONF = 'dorm_detective.urls'
...
WSGI_APPLICATION = 'dorm_detective.wsgi.application'
...
LOGIN_REDIRECT_URL = '/dorm-detective/'
